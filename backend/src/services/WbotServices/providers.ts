              ...
              if (totalCount === 0) {
                ...
                axios.request(optionsListpaymentOVERDUE as any).then(async function (response) {
                  ...
                  if (totalCount_overdue === 0) {
                    ...
                    value_overdue_corrigida = value_overdue.toLocaleString('en-us', { style: 'currency', currency: 'BRL' });
                    const body = {
